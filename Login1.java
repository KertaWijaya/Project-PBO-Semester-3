...
//        this.setExtendedState(Login.MAXIMIZED_BOTH);
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon("C:\\Users\\Tiaraaa\\PBO\\GUI(2)\\GUI(2)\\GUI\\src\\main\\java\\com\\pbo\\gui\\image\\LogoLarge.png")); // NOI18N
    ...
    private void LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginActionPerformed
        ...
        if (email.isEmpty() || password.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Email dan Password harus diisi.", "Login Gagal", JOptionPane.ERROR_MESSAGE);
        } else {
            try {
